...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{ route('stock.index') }}" class="nav-link">
                        <i class="fa fa-recycle nav-icon" aria-hidden="true"></i>
    ...
    I am a writer!
                ...
                <li class="nav-header">Albums Details</li>

                <li class="nav-item">
                    <a href="{{ route('album.show') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('job_categories.show') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('jobs.show') }}" class="nav-link">
